...
namespace GuessNumLibrary
{
    public static class PlayerGuessNumber
    {
        ...
        public static string MakeAGuess(int userNum, int winningNumber)
        {
            string message = "";
            ...
            else if (userNum > winningNumber)
            {
                ...
                message = ("Your answer was too high!");
            }

            else if (userNum < winningNumber)
            {

                message = ("Your answer was too low!");
            }
